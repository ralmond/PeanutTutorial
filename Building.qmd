...
This table is the easiest to understand. Each row represents a Bayes net model, either a competency model or an evidence model. The columns have the following meaning.
