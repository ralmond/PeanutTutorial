...
#### Start with the proficiency model.
...
Nodes whose CPT we want to learn are marked as "pnodes". Get a list of these
...
1)  *E-step* run Netica's EM algorithm to calculate expected tables.

2)  *M-step* run maximizer to adjust parameters to be close to expected table.
