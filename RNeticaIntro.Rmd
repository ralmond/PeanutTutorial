...
![Peanut Package Dependencies](../figures/PnetPackages.png)
...
![Netica Session and Netica Heap](../figures/RNetica-Netica1.png)
...
```{r Start without license, eval=FALSE}
library(RNetica)
sess <- NeticaSession()
startSession(sess)
```
...
![ACED Motif 1](../figures/miniACEDPnet.svg)
...
profNodes <- NetworkNodesInSet(profModel,"pnodes")
NodeSets(sgp)
```
