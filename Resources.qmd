...
The R package `RNetica` provides an R binding of the Netica API (hence, it requires the API and not GUI license).
`RNetica` is available at <https://ralmond.r-universe.dev/> (source code is at <https://github.com/ralmond/>).
