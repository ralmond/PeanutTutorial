...
2.  `RNetica` links R to the [Netica](https://norsys.com) Bayes net engine. _Note: non-trivial uses of RNetica require a Netica API (not GUI) license from [Norsys](https://norsys.com)._
